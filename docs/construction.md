...
별도 후속 작업이 필요한 계약 차이도 확인했다. CAL01은 거래 요약이 날짜 셀 내부가 아니라 picker 아래 chip으로 표시되고, WAL01은 초기 보유 잔액/유상 충전 구분·실제 사용자·request ID/payload hash 계약이 아직 완성되지 않았다. 두 항목은 캘린더 교체와 금융 migration 검토가 필요하므로 이 보강에서 임의로 확장하지 않았다.
